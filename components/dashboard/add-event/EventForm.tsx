...
//         | null
//         | Dayjs
//         | EventFormState["optionCategories"]
//         | EventFormState["reservationSettings"]
//     ) => {
...
//     (
//       newEventType: "class" | "camp" | "workshop" | "artist" | "reservation"
//     ) => {
//       setFormData({
//         eventName: "",
...
//         setErrors((prev) => ({
//           ...prev,
//           image: "Please enter an event name first",
//         }));
//         return;
//       }
...
//           isRecurring:
//             formData.eventType !== "reservation" ? formData.isRecurring : false,
//           ...(formData.eventType === "reservation" &&
//             formData.endDate && {
...
//                                 type="button"
//                                 onClick={() =>
//                                   removeOptionCategory(categoryIndex)
//                                 }
...
//                                 type="button"
//                                 onClick={() =>
//                                   addChoiceToCategory(categoryIndex)
//                                 }
...
//                       onChange={(e) =>
//                         handleNestedChange("discount.name", e.target.value)
//                       }
//                       autoComplete="new-password"
//                       autoCapitalize="none"
//                       autoCorrect="off"
...
//                       onChange={(e) =>
//                         handleNestedChange("discount.type", e.target.value)
//                       }
//                       autoComplete="new-password"
//                       data-lpignore="true"
//                       data-form-type="other"
...
//                     <select
//                       value={
//                         formData.discount?.minParticipants?.toString() || "2"
//                       }
//                       onChange={(e) =>
//                         handleNestedChange(
...
//                           (Applies when{" "}
//                           {formData.discount?.minParticipants || 2} or more
...
//                         dayPricing: prev.reservationSettings?.dayPricing || [
